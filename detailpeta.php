...
$query_toko = "
    SELECT t.id, t.name AS toko_name, t.address, t.description, 
           t.latitude, t.longitude, t.kecamatan_id, k.name AS kecamatan_name, t.image_url
    FROM toko t
            ...
            <div class="card-body">
                ...
                <tr>
                        ...
                        <?php if (!empty($toko['image_url'])) { ?>
                            <img src="uploads/<?php echo $toko['image_url']; ?>" 
                                alt="<?php echo $toko['toko_name']; ?>" 
                                style="max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
                        <?php } else { ?>
                            <p class="text-danger">Foto toko tidak tersedia.</p>
                        <?php } ?>
                    </td>
                    </tr>
                    <tr>
